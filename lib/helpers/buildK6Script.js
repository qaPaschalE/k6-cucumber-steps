...
export function handleSummary(data) {
  ...
  const linkToCucumber = \`<div style="padding:10px;margin-top:20px;text-align:center">
    <a href="load-results.html" target="_blank" style="font-size:18px;color:#007acc;">
      🔗 View Cucumber Test Report
    </a>
  </div>\`;

  return {
    "reports/k6-report.html": html.replace("</body>", \`\${linkToCucumber}</body>\`),
